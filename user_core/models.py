...
class WalletAddress(models.Model):
    ...
    litecoin_address  = models.CharField(max_length=100,blank=True,null=True)
    xrp_address  = models.CharField(max_length=100,blank=True,null=True)
    etherum_address  = models.CharField(max_length=100,blank=True,null=True)
